...
If the required strategy would establish/change project-wide migration policy beyond the assigned Jira scope, stop the dependent work and return that decision to Main as replan/approval evidence. Do not update a local plan or encode one execution unit's choice as repository convention.
