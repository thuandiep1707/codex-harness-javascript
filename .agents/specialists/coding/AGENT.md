...
- Register owned runtime resources immediately with transient runtime-resource acquire events to Main; do not wait until the end of the execution unit.
