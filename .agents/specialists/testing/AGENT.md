...
- Register the owned resource immediately when it starts using a transient runtime-resource acquire event to the Primary Controller.
...
- If cleanup cannot be completed safely or verified, return the unresolved runtime resource through the Primary Controller and do not claim `agent-ready-to-close: true`.
